	...
	$.ajax({
		...
		success:function(data){
			...
			for(i=0;i<project.length;i++){
				...
				if ((myDate.getMonth() < birthDate.getMonth()&&project[i].pschedule<100) || (myDate.getMonth() == birthDate.getMonth() && myDate.getDate() < birthDate.getDate()&&project[i].pschedule<100)) {
